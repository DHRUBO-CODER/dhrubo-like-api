...
class LikeAPI:
    ...
    def extract_player_info(self, data: Dict[str, Any]) -> Tuple[str, int]:
        ...
        nickname = basic_info.get("nickname", "Unknown Player")
...
def run_local_server(port=8000):
    ...
    print(f"📝 টেস্ট করুন: http://localhost:{port}/like?uid=2887682120&server=BD")
    print(f"📝 টেস্ট করুন: http://localhost:{port}/like?uid=2887682120&server=IN")
    print(f"📝 টেস্ট করুন: http://localhost:{port}/like?uid=2887682120&server=US")
